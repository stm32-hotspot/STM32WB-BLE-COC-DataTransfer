...
#define BLE_COC    1    /*1 = Device is Peripherique*/

#define CFG_DEV_ID_BLE_COC                  (0xA3)
...
#define DATA_MAX_PACKET_SIZE           247
...
typedef enum
{
  ...
  CFG_TASK_DATA_TRANSFER_ID,
  CFG_TASK_DATA_WRITE_ID,
  CFG_TASK_TOGGLE_CONN_INT_ID,
